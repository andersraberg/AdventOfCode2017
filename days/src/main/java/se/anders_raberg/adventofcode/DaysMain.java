...
import se.anders_raberg.adventofcode.day16.Day16a;
import se.anders_raberg.adventofcode.day16.Day16b;
...
import se.anders_raberg.adventofcode.day19.Day19a;
import se.anders_raberg.adventofcode.day19.Day19b;
...
public class DaysMain {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        Day15a.run();
        Day15b.run();
        Day16a.run(INPUT_PATH);
        Day16b.run(INPUT_PATH);
        Day17a.run();
        Day17b.run();
        Day18a.run(INPUT_PATH);
        Day18b.run(INPUT_PATH);
        Day19a.run(INPUT_PATH);
        Day19b.run(INPUT_PATH);
    }
}
